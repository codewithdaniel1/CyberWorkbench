...
- **CyberChef Cryptography RAG** — a versioned, local-only knowledge-card corpus retrieves relevant cryptography guidance for each analysis. It covers layered encodings, JWT limitations, symmetric-key prerequisites, KDFs, hashes, PGP/public keys, XOR, classical ciphers, and signatures. It advises every installed Ollama model but cannot override CyberChef validation or execution.
