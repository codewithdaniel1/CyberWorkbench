...
import { operationArguments } from "../../desktop/operationArgs.mjs";
...
assert.deepEqual(operationArguments([
    { type: "editableOption", value: [{ name: "Standard", value: "A-Za-z0-9+/=" }] },
    { type: "boolean", value: true },
    { type: "boolean", value: false }
]), ["A-Za-z0-9+/=", true, false]);
assert.deepEqual(operationArguments([{ type: "string", value: "default" }], ["custom"]), ["custom"]);

console.log("Cyber Workbench agent helper tests passed (17 checks).");
