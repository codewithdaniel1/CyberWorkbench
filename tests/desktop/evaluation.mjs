...
import { evaluationCases, scoreAgentRun, scoreModelResponse, scorecardSummary } from "../../desktop/evaluation.mjs";
...
console.log("Cyber Workbench agent-scorecard evaluation passed (10 scoring checks).");
